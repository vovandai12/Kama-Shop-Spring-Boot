			...
			<div class="container">
				...
				<div id="forgot-password" class="row">
					<div
						...
						<form class="login-form" action="/auth/admin/forgot-password"
							method="post">
							<div class="row">
							...
							<div class="row">
								<div class="input-field col s12">
									<i class="material-icons prefix pt-2">person_outline</i> <input
										id="email" name="email" type="text"> <label for="email"
