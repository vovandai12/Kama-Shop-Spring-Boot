...
function deleteLike(id, fullName) {
	swal({
		title: "Are you sure?",
		text: "You have want to delete like " + fullName + ". You will not be able to recover this imaginary file!",
		icon: "warning",
		dangerMode: !0,
		buttons: {
			cancel: "No, Please!",
		...
		e ? $.ajax({
			type: "DELETE",
			url: baseUrl + "/admin/like/delete/" + id,
			success: function() {
